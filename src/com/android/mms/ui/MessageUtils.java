...
public class MessageUtils {
    ...
    /**
     * Return the icc uri according to phoneId
     */
    public static Uri getIccUriByPhoneId(int phoneId) {
        switch (phoneId) {
            case PHONE1:
                return ICC1_URI;
            case PHONE2:
    ...
    public static byte[] getDeliveryPdu(String scAddress, String destinationAddress, String message,
            long date, int phoneId) {
        if (isCdmaPhone(phoneId)) {
     ...
     * Generate a Delivery PDU byte array. see getSubmitPdu for reference.
     */
    public static byte[] getGsmDeliveryPdu(String scAddress, String destinationAddress, String message,
    ...
    public static int getSmsPreferStoreLocation(Context context, long phoneId) {
        ...
        if (isMultiSimEnabled()) {
            if (phoneId == PHONE1) {
                preferStore = Integer.parseInt(prefsms.getString("pref_key_sms_store_sim1", "0"));
            } else {
                preferStore = Integer.parseInt(prefsms.getString("pref_key_sms_store_sim2", "0"));
            }
        } else {
