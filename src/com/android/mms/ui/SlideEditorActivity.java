...
public class SlideEditorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextEditor.setFilters(new InputFilter[] {
                new LengthFilter(MessageUtils.SLIDE_TEXT_LIMIT_SIZE)});
    ...
    private final OnTextChangedListener mOnTextChangedListener = new OnTextChangedListener() {
        ...
        public void onTextChanged(String s) {
            ...
            if (!isFinishing()) {
                ...
                int remainSize = mSlideshowModel.getAndUpdateMessageSize()
                        - mSubjectSize - inputSize;
                remainSize = remainSize < 0 ? 0 : remainSize;
                if (DEBUG) {
                    Log.v(TAG,"remainSize = "+remainSize);
                }

                if (remainSize == 0 || (mSlideshowModel.getAndUpdateMessageSize() + beforeInputSize)
                        < currentInputSize) {
